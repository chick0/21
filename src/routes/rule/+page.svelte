...
<Block>
    ...
    <ol>
        <li>플레이어의 숫자 합이 21인지 확인합니다.</li>
        <li>상대 플레이어의 숫자 합이 21인지 확인합니다.</li>
        <li>모든 플레이어의 숫자 합이 동일하면 무승부로 처리합니다.</li>
        <li>한 명의 플레이어만 숫자 합이 21을 넘겼다면 그 플레이어가 패배합니다.</li>
        <li>
            모든 플레이어의 숫자 합이 21을 넘겼다면 숫자 합이 21과 가까운 플레이어가 승리합니다.
        </li>

        <li>나머지 상황은 무승부로 처리합니다.</li>
    </ol>
</Block>
