...
<ol>
    <li><b>Ace</b> 카드는 1 또는 11로 계산합니다.</li>
    <li><b>Jack</b> 카드는 {POINT_JACK}으로 계산합니다.</li>
    <li><b>Queen</b> 카드는 {POINT_QUEEN}으로 계산합니다.</li>
    <li><b>King</b> 카드는 {POINT_KING}으로 계산합니다.</li>
</ol>

<h2>승패 처리 규칙</h2>

<p>승/패 처리는 다음과 같은 순서대로 진행됩니다.</p>
